    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/proveedor/**")
                        .hasRole(Rol.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/api/proveedor/**")
                        .hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
                        .requestMatchers(HttpMethod.PUT, "/api/proveedor/**")
                        .hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
                        .requestMatchers(HttpMethod.GET, "/api/proveedor/**")
